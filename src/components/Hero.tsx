            ...
            <div className="bg-blue-900 p-6 sm:p-8 rounded-none shadow-2xl shadow-slate-950/50 border border-blue-800 flex flex-col space-y-6">
              ...
              <form onSubmit={handleSearchSubmit} className="space-y-4">
                <div className="space-y-1">
                  <label htmlFor="from-city" className="block text-[10px] uppercase font-bold tracking-wider text-blue-300">
                    Asal Keberangkatan
                  </label>
                ...
                <div className="space-y-1">
                  <label htmlFor="to-city" className="block text-[10px] uppercase font-bold tracking-wider text-blue-300">
                    Pilih Kota Tujuan
                  </label>
                  <div className="relative">
                    <select
