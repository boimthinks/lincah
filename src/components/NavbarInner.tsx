        ...
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-1 lg:space-x-4">
            {navItems.map((item) => (
              <a
                key={item.id}
                href={item.path}
                className="px-3 py-2 rounded-none text-xs font-bold uppercase tracking-wider transition-colors duration-200 text-slate-600 hover:text-blue-700 hover:bg-slate-50"
              >
                {item.name}
              </a>
            ))}
          ...
          <div className="md:hidden flex items-center">
            <button
              ...
              className="p-2 rounded-none transition-colors cursor-pointer border text-slate-700 hover:bg-slate-100 border-slate-200"
            >
