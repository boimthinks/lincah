...
import { Search, Clock, Calendar, MapPinCheck } from 'lucide-react';
  ...
  return (
    <section id="travel" className="py-0 sm:py-16 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* ALL SOUTH SUMATRA REGIONS / WILAYAH LAINNYA */}
        <div>
              ...
              <div className="divide-y divide-slate-100">
                {filteredRoutes.map((route, i) => (
                  ...
                  >
                    ...
                    <div className="col-span-1 md:col-span-2 border-l-0 md:border-l border-slate-100 pl-0 md:pl-4">
