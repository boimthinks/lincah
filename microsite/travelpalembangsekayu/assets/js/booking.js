(function() {
  ...
  // Daftar lokasi rute & daerah yang dilalui koridor Palembang - Pangkalan Balai - Betung - Talang Duku Jaya - Ipil - Bailangu - Sekayu
  const CITIES = [
    'Palembang',
    'Pangkalan Balai',
    'Betung',
  ...
  // Tarif default per penumpang (door-to-door) rute Palembang - Sekayu
  const TARIF_PER_PAX = 150000;
  ...
  function updateDestinationOptions() {
    ...
    if (currentTo && currentTo !== selectedFrom && CITIES.includes(currentTo)) {
      ...
      bkTo.value = selectedFrom === 'Palembang' ? 'Sekayu' : 'Palembang';
    }
  }
  ...
  if (bookingForm) {
    bookingForm.addEventListener('submit', async (e) => {
      ...
      const waText = `*PEMESANAN TRAVEL PALEMBANG SEKAYU*
No. Ref: *#${noNota}*
...
Terima kasih!`;
      ...
      const totalTarif = TARIF_PER_PAX * paxNum;
